...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.headers().contentTypeOptions().disable()
                ...
                .antMatchers("/api/user/login","/api/user/login/app","/api/user/register",
                        "/api/event/add","/api/user/send","/api/alarmVideo/add",
                        "/api/user/register/app", "/index/hook/**","/index/hook/abl/**", "/swagger-ui/**", "/doc.html").permitAll()
