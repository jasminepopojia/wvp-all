...
public interface DeviceChannelMapper {
    ...
    @Update("UPDATE wvp_device_channel SET stream_url = #{streamUrl} WHERE device_id = #{deviceId}")
    int updateStreamUrl(@Param("deviceId") String deviceId, @Param("streamUrl") String streamUrl);

    @Select("SELECT channel_id FROM wvp_device_channel WHERE device_id = #{deviceId}")
    String getChannelIdByDeviceId(@Param("deviceId") String deviceId);
