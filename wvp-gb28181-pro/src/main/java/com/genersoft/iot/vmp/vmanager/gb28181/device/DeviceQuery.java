...
public class DeviceQuery {
	 ...
	 */
	@PostMapping("/stream")
	public ResponseEntity<?> updateStreamUrl(@RequestParam String deviceId, @RequestParam String videoUrl) {
		boolean updated = deviceChannelService.updateStreamUrl(deviceId, videoUrl);
		if (updated) {
			return ResponseEntity.ok().body("Stream URL updated successfully");
		} else {
