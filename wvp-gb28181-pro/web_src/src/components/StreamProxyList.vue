<template>
	<div id="streamProxyList" style="width: 90%;margin-left: 150px;">
    <div class="page-header">
      <div class="page-title">拉流代理列表</div>
      <div class="page-header-btn">
        <el-button icon="el-icon-plus" size="mini" style="margin-right: 1rem;background-color: #1890FF" type="primary" @click="addStreamProxy">添加代理</el-button>
