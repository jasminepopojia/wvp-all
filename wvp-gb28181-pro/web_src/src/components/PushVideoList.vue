<template>
  <div id="pushVideoList" style="width: 90%;margin-left: 150px;">
    <div class="page-header">
      ...
      <div class="page-header-btn">
        ...
        <el-button icon="el-icon-upload2" size="mini" style="margin-right: 1rem;background-color: #1890FF" type="primary" @click="importChannel">
          通道导入
        </el-button>
        <el-button icon="el-icon-download" size="mini" style="margin-right: 1rem;background-color: #1890FF" type="primary">
        ...
        <el-button icon="el-icon-plus" size="mini" style="margin-right: 1rem;background-color: #1890FF" type="primary" @click="addStream">添加通道
        </el-button>
