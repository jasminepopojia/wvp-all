<template>
  <div id="app" style="width: 90%;margin-left: 150px;">
...
<!--        <el-button size="mini" icon="el-icon-delete" type="danger" @click="deleteRecord()">批量删除</el-button>-->
    ...
    <el-table :data="recordList" style="width: 100%" :height="winHeight">
      ...
      <el-table-column label="操作" width="200" fixed="right">
        <template slot-scope="scope">
          <el-button size="medium" icon="el-icon-video-play" style="color:#1890FF" type="text" @click="play(scope.row)">播放
          </el-button>
          <el-button size="medium" icon="el-icon-download" type="text" style="color:#1890FF" @click="downloadFile(scope.row)">下载
          </el-button>
