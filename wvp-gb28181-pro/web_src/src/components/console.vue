<template>
  <div id="app"  style="width: 100%;margin-left: 150px;">
    <div class="page-header">
      <div class="page-title">控制台</div>
      <div class="page-header-btn">
        <el-button icon="el-icon-info" size="mini" style="margin-right: 1rem;background-color: #1890FF" type="primary" @click="showInfo">平台信息
        </el-button>
      </div>
    </div>
