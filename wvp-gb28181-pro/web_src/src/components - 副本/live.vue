    ...
    <el-container v-loading="loading" style="height: 91vh;" element-loading-text="拼命加载中">
      ...
      <el-container>
        ...
        <el-main style="padding: 0;">
          <div style="width: 100%;height: 80vh;display: flex;flex-wrap: wrap;background-color: #000;">
            <div class="play-box":style="liveStyle">
             <div v-if="!videoUrl[playerIdx]" style="color: #ffffff;font-size: 30px;font-weight: bold;">{{ playerIdx+1 }}</div>
              <player :playerIdx="playerIdx"  ref="player"  fluent autoplay @screenshot="shot" @updateValue="updateParentValue"
                      @destroy="destroy" />
